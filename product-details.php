...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
	...
	<source src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage3']);?>" type="video/mp4">
	</video> 
                </a>
            </div>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6" style=>
										<div class="price-box">
											<span class="price">RM <?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
