...
$_SESSION['sid']=$pd;
					...
					<td class="cart-image">
						<div class="entry-thumbnail" href="">
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "RM"." ".$row['productPriceBeforeDiscount']; ?></span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "RM"." ".$row['shippingCharge']; ?></span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price">RM <?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPriceBeforeDiscount']+$row['shippingCharge']); ?>.00</span></td>
